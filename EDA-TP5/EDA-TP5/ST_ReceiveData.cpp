...
{
    cout << "Previous state: Waiting to receive data " << endl << "Event received: timeout. ACK was resent " << endl << "New state: Waiting to receive data" << endl << endl;
...
{
    cout << "Previous state: Waiting to receive data" << endl << "Event received: last data was received" << endl << "New state: Waiting to send ACK" << endl << endl;
